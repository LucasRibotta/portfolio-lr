        ...
        <div className='min-h-[70vh] flex flex-col-reverse p-4 mt-4 lg:grid lg:grid-cols-2 bg-white items-center rounded-[50px] overflow-hidden  shadow-lg shadow-slate-900' id="home">
            <div className='px-6 md:px-12 flex flex-col gap-12 items-start'>
                <div className='flex flex-col gap-4'>
                    ...
                    <h2 className='text-2xl text-violet-800 font-extrabold'>Hi, my name is Lucas Ribotta!</h2>

                    <div className='flex flex-col text-base md:text-xl'>
                        <p>I&#39;m a FrontEnd developer, passionate about learning.</p>
                        <p>I&#39;m passionate about creating attractive and functional user interfaces.</p>
                        <p>I love working in a team and collaborating with other developers.</p>
                        <p>I&#39;m open to new job opportunities.</p>
                        <p>If you want to contact me, you can do so through my social networks!</p>
                    </div>

                </div>
                <div className="flex gap-4 text-black">
                    <a href="https://www.linkedin.com/in/lucas-ribotta/" target="blank" >
                    ...
                    <a href="https://api.whatsapp.com/send?phone=3534236236" target="blank" >
