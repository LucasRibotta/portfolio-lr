...
const About = () => {
    return (
        <div className=' min-h-[60vh] flex flex-col-reverse px-4 lg:grid lg:grid-cols-2 bg-white items-center rounded-[50px] overflow-hidden  shadow-lg shadow-slate-900' id="about">
            <div className='p-4 md:p-12 flex flex-col gap-6 md:gap-10 h-full items-center justify-center'>
                ...
                <div className='flex flex-col gap-4 md:gap-8 items-center justify-center'>
                    ...
                    <p className='text-start md:text-justify text-lg md:text-xl'>
                    ...
                    <Link href='https://docs.google.com/document/d/1sBn1lfxO2Dhezv_1LNKoke610HtxyfPzD3tsjCKc8Iw/edit?usp=sharing' className='text-2xl rounded-full mt-[1rem] text-center items-center px-6 py-3 bg-violet-900 font-semibold text-white  hover:bg-violet-600 hover:text-violet-400 transition-all duration-300 ' target='blank' >
                        Curriculum
                    </Link>
                </div>
            </div>
